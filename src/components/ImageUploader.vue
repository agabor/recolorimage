...
const resizeInfo = computed(() => {
  ...
  return `Resized from ${originalDimensions.value.width}<i class="fa-solid fa-xmark"></i>${originalDimensions.value.height} to ${resizedDimensions.value.width}<i class="fa-solid fa-xmark"></i>${resizedDimensions.value.height}`;
});
</script>
